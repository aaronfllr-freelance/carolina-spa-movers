...
const ResidentToResidentEmail: React.FC<EmailProps> = ({ formData }) => (
  <Html lang="en">
    <head>
      <meta charSet="UTF-8" />
    ...
    <body style={{ fontFamily: 'Arial, sans-serif', color: '#333', lineHeight: '24px' }}>
      <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
        ...
        {formData.destinationSteps && (
          <Text style={{ fontSize: '16px', margin: '8px 0' }}>Destination Steps: {formData.destinationSteps}</Text>
        )}
        {formData.destinationAccess && (
          <Text style={{ fontSize: '16px', margin: '8px 0' }}>Destination Access: {formData.destinationAccess}</Text>
        )}
...
export default ResidentToResidentEmail;
